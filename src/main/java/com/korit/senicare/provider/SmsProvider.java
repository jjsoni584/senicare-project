...
public class SmsProvider {
    private final DefaultMessageService messafService;
    ...
    public SmsProvider(
        ...
        this.messafService=NurigoApp.INSTANCE.initialize(apiKey, apiSecretKey, domain);
        this.from = from;
    }
    ...
    public boolean sendMessage(String to, String authNumber){
        ...
        SingleMessageSentResponse response = messafService.sendOne(request);
